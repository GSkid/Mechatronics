...
#define TIMER3_RESP_FUNC PostBeaconDetectorService
#define TIMER4_RESP_FUNC PostPingService
#define TIMER5_RESP_FUNC PostTopLevelHSM
#define TIMER6_RESP_FUNC PostBumperService
...
#define Generic_Timer 1 /*make sure this is enabled above and posting to the correct state machine*/
#define TAPE_SENSOR_TIMER 2
#define BEACON_TIMER 3
#define PING_TIMER 4
#define DRIVING_TIMER 5
#define BUMPER_TIMER 6
#define DANCING_TIMER 7
#define DISPENSE_TIMER 8
...
// the name of the run function
#define SERV_1_RUN RunTopLevelHSM
...
#if NUM_SERVICES > 2
// the header file with the public fuction prototypes
#define SERV_2_HEADER "TapeSensorService.h"
// the name of the Init function
#define SERV_2_INIT InitTapeSensorService
// the name of the run function
#define SERV_2_RUN RunTapeSensorService
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public fuction prototypes
#define SERV_3_HEADER "BeaconDetectorService.h"
// the name of the Init function
#define SERV_3_INIT InitBeaconDetectorService
// the name of the run function
#define SERV_3_RUN RunBeaconDetectorService
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public fuction prototypes
#define SERV_5_HEADER "BumperService.h"
// the name of the Init function
#define SERV_5_INIT InitBumperService
// the name of the run function
#define SERV_5_RUN RunBumperService
// How big should this services Queue be?
...
#if NUM_DIST_LISTS > 0 
#define DIST_LIST0 PostTopLevelHSM
#endif
#if NUM_DIST_LISTS > 1 
#define DIST_LIST1 PostTopLevelHSM
#endif
#if NUM_DIST_LISTS > 2 
#define DIST_LIST2 PostTopLevelHSM
#endif
#if NUM_DIST_LISTS > 3 
#define DIST_LIST3 PostTopLevelHSM
#endif
#if NUM_DIST_LISTS > 4 
#define DIST_LIST4 PostTopLevelHSM
#endif
#if NUM_DIST_LISTS > 5 
#define DIST_LIST5 PostTopLevelHSM
#endif
#if NUM_DIST_LISTS > 6 
#define DIST_LIST6 PostTopLevelHSM
#endif
#if NUM_DIST_LISTS > 7 
#define DIST_LIST7 PostTopLevelHSM
#endif
